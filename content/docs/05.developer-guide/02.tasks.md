...
Each value of the variable and each subtask will run sequentially.
...
This task is the same as EachSequential, but each value of the variable and each subtask will run in parallel.
